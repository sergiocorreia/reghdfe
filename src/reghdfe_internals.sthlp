...
TODO: RENAME TO reghdfe_programming and split into MATA and normal parts


{syntab:Programmer's options}
{synopt :{opt nopartial:_out}}stop before partialling out. will keep the mata HDFE object, and allow extra options in {opt HDFE.extra_options}{p_end}
{synopt :{opt noreg:ress}}stop before regressing. will keep the mata HDFE object, and allow extra options in {opt HDFE.extra_options}{p_end}
{synopt :{opt keepmata}}keep the mata HDFE object{p_end}
