...
* [TEST] Will compare reghdfe against ivreg2
	...
	* Unadjusted
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(unadjusted) keepsingletons
	TrimMatrix `K'
	...
	* Robust
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(robust) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')
	...
	* Autoco
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(, bw(2)) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')

	reghdfe `lhs' `rhs', absorb(`absvars') vce(, bw(2) suite(avar)) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')
	...
	* Autoco + Kernel
	...
	TrimMatrix `K'
	storedresults save benchmark e()
	reghdfe `lhs' `rhs', absorb(`absvars') vce(, bw(2) kernel(par)) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')
	storedresults drop benchmark
	...
	* dkraay
	...
	TrimMatrix `K'
	storedresults save benchmark e()
	reghdfe `lhs' `rhs', absorb(`absvars') vce(, dkraay(3)) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')
	storedresults drop benchmark
	...
	* kiefer
	...
	TrimMatrix `K'
	storedresults save benchmark e()
	reghdfe `lhs' `rhs', absorb(`absvars') vce(, kiefer) keepsingletons
	TrimMatrix `K'
	storedresults compare benchmark e(), tol(1e-6) include(`included')
	storedresults drop benchmark
	...
	* Cluster
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(cluster turn t`i', suite(default)) dof(none) tol(1e-12) keepsingletons
	TrimMatrix `K'
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(cluster turn t`i', suite(mwc)) dof(none) tol(1e-12) keepsingletons
	TrimMatrix `K'
	if (`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included')
	if (!`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included_subset')

	reghdfe `lhs' `rhs', absorb(`absvars') vce(cluster turn t`i', suite(avar)) dof(none) tol(1e-12) keepsingletons
	TrimMatrix `K'
	if (`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included')
	if (!`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included_subset')
	...
	* Cluster + Autoco
	...
	reghdfe `lhs' `rhs', absorb(`absvars') vce(cluster turn t`i', bw(5)) dof(none) keepsingletons
	TrimMatrix `K'
	if (`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included')
	if (!`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included_subset')
	storedresults drop benchmark
	...
	* Cluster + Autoco + kernel
	...
	TrimMatrix `K'
	storedresults save benchmark e()
	reghdfe `lhs' `rhs', absorb(`absvars') vce(cluster turn t`i', bw(5) kernel(thann)) dof(none) keepsingletons
	TrimMatrix `K'
	if (`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included')
	if (!`fullrank') storedresults compare benchmark e(), tol(1e-6) include(`included_subset')
	storedresults drop benchmark
